Shareable.configure do |config|
  ...
  ##facebook
  ###############
  config.app_id= ENV['FACEBOOK_KEY'] # required if using facebook button!
  #config.send= 'false'
  config.layout='button' # 'standard', 'button_count', 'button' or 'box_count'. '' defaults to 'standard'.
  ...
  config.count='none' # 'none', 'horizontal' or 'vertical'. '' defaults to 'horizontal'.
  #config.lang='en'
